...
namespace Dern_Support.Migrations
{
    ...
    [Migration("20240911205156_seedKBA")]
    partial class seedKBA
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dern_Support.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Dern_Support.Models.InventoryItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Dern_Support.Models.KnowledgeBaseArticle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PublishedDate = new DateTime(2024, 9, 11, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ...
                            PublishedDate = new DateTime(2024, 9, 10, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ...
                            PublishedDate = new DateTime(2024, 9, 9, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Title = "Steps to Resolve Computer Overheating"
                        });
                });

            modelBuilder.Entity("Dern_Support.Models.RepairJob", b =>
                {
            ...
            modelBuilder.Entity("Dern_Support.Models.SupportRequest", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "1",
                            ConcurrencyStamp = "9ab7490a-43f6-43f4-8e03-7c2f3b60e781",
                            Name = "Customer",
                        ...
                        {
                            Id = "2",
                            ConcurrencyStamp = "4238bb97-16bc-4f3c-b01b-14713c98bdf0",
                            Name = "Technician",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Dern_Support.Models.ApplicationUser", null)
                        .WithMany()
